...
describe('Validators Helper Functions', () => {
  ...
  describe('validateRequest', () => {
    ...
    it('should call throwCustomError if validation fails for body', () => {
      ...
      expect(commonHelpers.throwCustomError).toHaveBeenCalledWith('name is required', 422);
    ...
    it('should call throwCustomError if validation fails for query', () => {
      ...
      expect(commonHelpers.throwCustomError).toHaveBeenCalledWith('age is required', 422);
      expect(mockNext).not.toHaveBeenCalled();
    });
    ...
    it('should call throwCustomError if validation fails for params', () => {
      ...
      expect(commonHelpers.throwCustomError).toHaveBeenCalledWith('id is required', 422);
      expect(mockNext).not.toHaveBeenCalled();
    });
  });
});
